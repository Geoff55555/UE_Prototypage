...
def parseInputReport():  # [2]L197
    ...
    try:
        ...
        if shtpData[5] == SENSOR_REPORTID_ACCELEROMETER:
            ...
            rawMagY = data2
            rawMagZ = data3
            if acc_print: print("[BNO080] magAcc = ", magAccuracy)
            ...
            # convert quat ? [5] L360
            if acc_print: print("[BNO080] quatAccuracy = ", quatAccuracy)  # here status == quatAccuracy
            ...
            if data_print: print("[BNO080] Sensor Report ID not handled")
