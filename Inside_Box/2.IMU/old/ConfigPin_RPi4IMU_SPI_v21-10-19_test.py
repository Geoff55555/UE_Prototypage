...
def beginSPI(user_bcm_CSPin, user_bcm_WAKPin, user_bcm_INTPin, user_bcm_RSTPin, user_spiPortSpeed, user_spiPort):  # [2]L33
    ...
    if waitForINT():  # wait for connection of INT Pin
        # spi launching
        ...
        waitForINT() # Wait for assertion of INT before reading Init response
        ...
        waitForINT()  # [2] wait for assertion of INT before reading Init response
