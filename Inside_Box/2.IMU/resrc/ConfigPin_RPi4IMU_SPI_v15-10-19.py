...
def parseCommandReport():
    ...
    if shtpData[0] == SHTP_REPORT_COMMAND_RESPONSE:
        ...
        print("[BNO080] COmmand ibyte is ", command)
...
def checkCalibration():  # [5]L70 + L108 + L311 mix
    ...
    # enableRotationVector(5)  # Send data update every 10ms
    # Enable Magnetic Field output -> only magneto
    # enableMagnetometer(5)  # Send data update every 10ms
