...
def on_message(client, userdata, message):
    ...
    if debugPrint: print("message topic =", message.topic)
    if debugPrint: print("message qos =", message.qos)
    # handling json
