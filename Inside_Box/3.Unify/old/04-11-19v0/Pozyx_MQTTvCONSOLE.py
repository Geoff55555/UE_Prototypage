...
class Tag:
    def __init__(self, user_topic, user_broker_address, user_client_name):
        global client, TOPIC, broker_address, roger  # to be able to write if necessary in those variables
    ...
    def start(self):
        # MAIN - connection
        global client, roger  # to be able to write if necessary in those variables
